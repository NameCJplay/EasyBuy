...
<%@page import="entity.news"%><html xmlns="http://www.w3.org/1999/xhtml">
<head>
			...
			<form action="news_update" method="post">
				<table class="form">
					<tr>
						...
						<td><input type="text" class="text" name="title" value="<%=ns.getEN_TITLE() %>" /></td>
					</tr>
					<tr>
						<td class="field">新闻内容：</td>
						<td><textarea name="content"><%=ns.getEN_CONTENT() %></textarea></td>
					</tr>
					<tr>
						<td><input type="hidden"  value="<%=ns.getEN_ID() %>" name="en_id"  /></td>
