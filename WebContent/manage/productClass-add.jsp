...
<%@page import="entity.product_category"%><html xmlns="http://www.w3.org/1999/xhtml">
<head>
...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>添加分类</h2>
		<div class="manage">
			<form action="AddPcServlet" method="post">
				<table class="form">
					<tr>
						...
						<td>
							<select name="parentId">
								...
								for(int i=0;i<pc.size();i++){
									product_category p=pc.get(i);
									
									if(p.getEPC_PARENT_ID()==0){
										%>
										<option value="<%=p.getEPC_ID() %>"><%=p.getEPC_NAME() %></option>
									<%
									}
