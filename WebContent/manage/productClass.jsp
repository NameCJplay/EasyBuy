	...
	<div class="main">
		...
		<div class="manage">
			<table class="list">
				...
				<tr id="${pclist.EPC_ID }">
					<td class="first w4 c">${pclist.EPC_ID }</td>
					<td class="childClass">${pclist. EPC_NAME}</td>
					<td class="w1 c">
						<a href="productClass-modify.jsp?id=${pclist.EPC_ID }">修改</a>
						<a href="javascript:ajaxDelete(${pclist.EPC_ID });">删除</a></td>
				</tr>
				</c:forEach>
			</table>
		</div>
